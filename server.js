...
function buildWelcomeCmd(sessionName) {
  ...
  return [
    ...
    'printf "\033[1;32m"',
    'printf "\n"',
    'printf "        ▄▄▄████▄▄▄              \033[1;32mB E B O\033[0m\n"',
    'printf "\033[1;32m     ▄██████████████▄           \033[1;32mH A C K I N G\033[0m\n"',
    'printf "\033[1;32m   ▄██████████████████▄\n"',
    'printf "\033[1;32m  ██████████████████████\n"',
    'printf "\033[1;32m ████▀▀██████████▀▀█████\n"',
    'printf "\033[1;32m ███    ██▀▀▀▀██    ███\n"',
    ...
    'printf "\033[32m  [+]\033[0m tmux real · multiplex\n"',
    authLine,
    'printf "\033[32m  workspace:\033[0m ~/workspace\n\n"',
    "exec bash -l",
  ].join(" && ");
}
